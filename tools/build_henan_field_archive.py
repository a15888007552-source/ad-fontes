...
COPY_REPAIRS: dict[str, list[str]] = {
    ...
    "A-009": [
        "1971年，黑陶澄滤器出土于河南淅川下王岗遗址，属于中原龙山文化。从河南淅川下王岗遗址出土的记录看，黑陶澄滤器的地点与年代相互校准，日常使用的判断因此有了边界。",
    ...
    "A-027": [
        "X纹彩陶罐出土于河南汝州，属于仰韶文化；更具体的地点尚待核定。河南汝州的出土信息把X纹彩陶罐放回具体年代，彩陶罐的器形与烧成线索仍需结合展签阅读。",
    ...
    "A-051": [
        "磨光黑陶觚出土于河南禹州瓦店遗址，属于夏代。从河南禹州瓦店遗址出土的记录看，磨光黑陶觚的地点与年代相互校准，日常使用的判断因此有了边界。",
    ...
    "b-092": [
        "展签记录，酱釉黑彩虎形瓷枕属于金代（1115—1234），来源为1968年修武县李固村出土。1968年修武县李固村的出土信息把酱釉黑彩虎形瓷枕放回具体年代，瓷枕的器形与烧成线索仍需结合展签阅读。",
    ...
    "b-099": [
        "展签记录，当阳峪窑白釉红绿彩缠枝花卉纹罐属于金代（1115—1234），来源为1973年焦作市出土。1973年焦作市的出土信息把当阳峪窑白釉红绿彩缠枝花卉纹罐放回具体年代，当阳峪窑瓷器的器形与烧成线索仍需结合展签阅读。",
    ...
    "b-101": [
        "展签记录，白地黑花瓷梅瓶属于宋代（960—1279），来源为1985年镇平县出土。1985年镇平县的出土信息把白地黑花瓷梅瓶放回具体年代，磁州窑系瓷器的器形与烧成线索仍需结合展签阅读。",
