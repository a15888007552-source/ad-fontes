(function () {
  ...
  function renderTreasureGrid() {
    ...
    const treasureDuplicateIds = new Set(["shaanxi-history-highlight-04", "shaanxi-history-highlight-11", "shaanxi-history-highlight-13"]);
    const treasureItems = items.filter((item) => hasTag(item, "forbidden") && !treasureDuplicateIds.has(String(item.id)));
