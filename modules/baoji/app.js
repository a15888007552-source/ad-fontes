  ...
  function labelArchiveMarkup(group) {
    ...
    const typeNote = (title) => {
      ...
      const notes = [
        {
          token: '甗',
          opening: '甗由上部甑和下部鬲组合而成，炊煮功能可从两部分的连接、箅孔与足部观察。',
        ...
        {
          token: '鼎',
          opening: '鼎以腹、耳、足为主要识别部位，基本用途可从炊煮或盛食讨论。',
          viewing: '按腹、耳、足的顺序查看，再放大纹带和可能的铭文位置。'
        },
        {
          token: '簋',
          opening: '簋是盛放黍稷等熟食的礼器，圈足、腹部、耳部和盖钮是判断形制的关键。',
          viewing: '先看腹部与圈足，再看耳部、盖钮和纹饰是否连续。'
        },
        {
          token: '觚',
          opening: '觚以细长器身、喇叭形口沿和高圈足为主要特征，常见于酒礼器组合。',
          viewing: '从口沿向下看器身收放，再看圈足、纹带和局部磨损。'
        },
        {
          token: '爵',
          opening: '爵的流、尾、鋬和三足共同构成器形，通常从温酒或饮酒礼器讨论。',
        ...
        {
          token: '卣',
          opening: '卣是有提梁的酒器，提梁、盖、腹部和圈足是观察重点。',
        ...
        {
          token: '盂',
          opening: '盂以宽口、深腹和圈足构成基本形制。',
          viewing: '从口沿向腹部观察器身比例，再看圈足和内外纹饰。'
        },
        {
          token: '钟',
          opening: '钟的扁体、枚、篆带和钲部是判断形制与悬挂方式的主要线索。',
          viewing: '先看钟体正侧面，再看枚、篆带、钲部和铭文局部。'
        },
        {
          token: '铙',
          opening: '铙以钟体、口沿和悬挂部位为主要观察对象。',
        ...
        {
          token: '剑',
          opening: '剑的剑身、脊、刃部和柄部共同构成形制，长度与装具可帮助讨论其使用方式。',
          viewing: '先看剑身整体，再看脊、刃部、柄部和装具残留。'
        },
        {
          token: '镞',
          opening: '镞的锋、翼、铤或穿是观察和分类的主要部位。',
        ...
        {
          token: '玉',
          opening: '玉器的材质、形制和穿孔或切割痕迹是可见的判断线索。',
