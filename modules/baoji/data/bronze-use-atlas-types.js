...
(function (root) {
  ...
  function type(spec) {
    ...
    return {
      ...
      notes: spec.notes || '器物的功能，可从形制、使用痕迹与出土语境来读。'
    };
  }
  ...
  const types = [
    ...
    type({ slug: 'fou', nameZh: '缶', nameEn: 'LARGE CONTAINER', romanization: 'FOU', categoryId: 'wine', shortFunction: '盛液 · 储存 · 容器', relationTypeIds: ['hu', 'lei', 'zun'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/fou-use-hero.png', notes: '缶的时代、形制与盛液用途，由实物、铭文和出土组合共同说明。' }),
    ...
    type({ slug: 'quan', nameZh: '权', nameEn: 'CALIBRATED WEIGHT', romanization: 'QUAN', categoryId: 'measures', shortFunction: '称量 · 校准 · 定制', relationTypeIds: ['liang', 'fangsheng', 'tongliang'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', notes: '权是衡器系统中的称量砝码，重量、铭文和成组关系用于确认其计量功能。外形近铃或坠饰的对象，要与权分开。' }),
    ...
    type({ slug: 'judiao', nameZh: '句鑃', nameEn: 'GOU-DIAO BELL', romanization: 'JUDIAO', categoryId: 'music', shortFunction: '持柄 · 击奏 · 礼乐', relationTypeIds: ['nao', 'zheng', 'duo'], sourceIds: ['NMC-MUSIC'], inventoryStatus: 'ADD', notes: '句鑃以细长柄部和向下张开的器口形成鲜明轮廓，常见于吴越礼乐传统。它另有一套器形，与普通甬钟或铙不同。' }),
    ...
    type({ slug: 'zhen', nameZh: '铜镇', nameEn: 'BRONZE WEIGHT', romanization: 'TONGZHEN', categoryId: 'daily-life', shortFunction: '压席 · 镇物 · 陈设', crossMuseumObjects: [{"title":"人形铜镇","museum":"西安博物院","period":"年代待考","itemId":"xian-017-4905","image":"../xian-museum/assets/photos/focus-4905.webp","href":"../xian-museum/index.html?item=xian-017-4905#collection","note":"人形器身低矮而重心稳定，适合置于席角压固铺陈；具体年代待考。"},{"title":"鎏金凤鸟铜镇","museum":"西安博物院","period":"年代待考","itemId":"xian-042-5008","image":"../xian-museum/assets/photos/focus-5008.webp","href":"../xian-museum/index.html?item=xian-042-5008#collection","note":"四件凤鸟形镇物低重心、成组保存，鎏金工艺兼顾陈设效果与席镇功能；具体年代待考。"}], relationTypeIds: ['jing', 'lian', 'xingzao'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['西安博物院 · 人形铜镇 / 凤鸟铜镇', '陕西历史博物馆 · 鎏金铜虎镇'], notes: '铜镇以紧凑重量和稳定底面压席或镇物，常结合动物或人物造型；承重姿态与底面磨损可帮助区别镇物和小型雕塑。' }),
    ...
    type({ slug: 'tongbi', nameZh: '铜币', nameEn: 'BRONZE CURRENCY', romanization: 'TONGBI', categoryId: 'other', shortFunction: '交换 · 计值 · 流通', relationTypeIds: ['tongliang', 'quan', 'tongyin'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['陕西历史博物馆 · 贵霜铜币'], notes: '铜币以铸造形制、重量和文字进入交换与计值体系。' }),
