...
(function (root) {
  ...
  const types = [
    ...
    type({ slug: 'gui', nameZh: '簋', nameEn: 'FOOD CONTAINER', romanization: 'GUI', categoryId: 'food-cooking', shortFunction: '盛食 · 礼食 · 陈设', localBaojiGroupIds: ['photo-group-3198', 'photo-group-3314', 'photo-group-3479'], relationTypeIds: ['ding', 'dou', 'fu'], sourceIds: ['BAOJI-OFFICIAL', 'BAOJI-PHOTO-INDEX', 'NMC-RITUAL'] }),
    type({ slug: 'fu', nameZh: '簠', nameEn: 'RECTANGULAR FOOD CONTAINER', romanization: 'FU', categoryId: 'food-cooking', shortFunction: '盛黍稷 · 礼食', relationTypeIds: ['gui', 'dun', 'xu'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/fu-use-hero.png', notes: '簠以方形与盖身关系区别于簋；类型归属不由本地照片数量决定。' }),
    ...
    type({ slug: 'yi', nameZh: '匜', nameEn: 'POURING VESSEL', romanization: 'YI', categoryId: 'water-pouring', shortFunction: '注水 · 倾注 · 盥洗', relationTypeIds: ['pan', 'he', 'jian-water'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/yi-use-hero.png', notes: '匜以流与持握结构区分于盉；没有宝鸡本地照片也不影响其 canonical 类型。' }),
