...
(function (root) {
  ...
  function type(spec) {
    ...
    return {
      ...
      notes: spec.notes || '器型纳入类型学总图；具体功能需结合器例与语境判断。'
    };
  }
  ...
  const types = [
    ...
    type({ slug: 'gui', nameZh: '簋', nameEn: 'FOOD CONTAINER', romanization: 'GUI', reading: 'guǐ', quickGuide: '圆腹、圈足，两侧常有耳，也有带盖者。商周祭祀与宴飨中用来盛黍稷等熟食，通常与鼎成组陈设。', categoryId: 'food-cooking', shortFunction: '盛食 · 礼食 · 陈设', localBaojiGroupIds: ['photo-group-3198', 'photo-group-3314', 'photo-group-3479'], relationTypeIds: ['ding', 'dou', 'fu'], sourceIds: ['BAOJI-OFFICIAL', 'BAOJI-PHOTO-INDEX', 'NMC-RITUAL'] }),
    type({ slug: 'fu', nameZh: '簠', nameEn: 'RECTANGULAR FOOD CONTAINER', romanization: 'FU', reading: 'fǔ', quickGuide: '器身近长方，盖与身往往同形，分开后都能放稳。西周晚期至春秋常用来盛饭食，并与簋一同出现在礼仪陈设中。', categoryId: 'food-cooking', shortFunction: '盛黍稷 · 礼食', relationTypeIds: ['gui', 'dun', 'xu'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/fu-use-hero.png', notes: '簠以方形与盖身关系区别于簋；类型归属不由本地照片数量决定。' }),
    ...
    type({ slug: 'dou', nameZh: '豆', nameEn: 'STEMMED FOOD DISH', romanization: 'DOU', reading: 'dòu', quickGuide: '浅盘置于高柄和圈足之上，有些带盖。它多盛肉酱、腌菜等佐食，在祭祀和宴席上成组摆放。', categoryId: 'food-cooking', shortFunction: '盛食 · 高置 · 奉食', relationTypeIds: ['gui', 'ding', 'yu'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/dou-use-hero.png', notes: '豆的高柄与斗的量取功能不同；高足杯不自动等同于豆。' }),
    type({ slug: 'dun', nameZh: '敦', nameEn: 'COVERED FOOD CONTAINER', romanization: 'DUN', reading: 'duì', quickGuide: '盖与器身合成近球形，两部分常各有足或钮，分开也能放稳。春秋战国时多用来盛黍稷等饭食，器名在这里读“对”。', categoryId: 'food-cooking', shortFunction: '盛食 · 盖合 · 陈设', relationTypeIds: ['gui', 'xu', 'ding'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/dun-use-hero.png', notes: '敦的盖身关系与器腹形态需按具体器例区分，不能直接并入簋。' }),
    type({ slug: 'yu', nameZh: '盂', nameEn: 'DEEP CONTAINER', romanization: 'YU', categoryId: 'food-cooking', shortFunction: '盛食 · 盛水 · 容纳', localBaojiGroupIds: ['photo-group-3437'], relationTypeIds: ['gui', 'pan', 'hu'], sourceIds: ['BAOJI-PHOTO-INDEX', 'NMC-YU-CLASS', 'NMC-YU-OBJECT'] }),
    ...
    type({ slug: 'fu-metal', nameZh: '鍑', nameEn: 'METAL CAULDRON', romanization: 'FU', categoryId: 'food-cooking', shortFunction: '炊煮 · 受火 · 容纳', relationTypeIds: ['ding', 'li', 'yan'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/fu-metal-use-hero.png', notes: '鍑作为釜类炊器的器类入口，具体形制与时代需依正式器例。' }),
    ...
    type({ slug: 'zeng', nameZh: '甑', nameEn: 'STEAMING VESSEL', romanization: 'ZENG', categoryId: 'food-cooking', shortFunction: '蒸食 · 透汽 · 分层', relationTypeIds: ['yan', 'li'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', notes: '甑是具有箅孔的上层蒸食器，可与釜、鬲等受火器配合。独立器例与甗的上下合体结构应分开记录。' }),
    ...
    type({ slug: 'you', nameZh: '卣', nameEn: 'LIDDED WINE CONTAINER', romanization: 'YOU', reading: 'yǒu', quickGuide: '收口有盖，常带提梁，器腹可作圆形、椭圆形或兽形。它是商周常见的盛酒、携酒礼器，经常与尊相配。', categoryId: 'wine', shortFunction: '贮酒 · 提携 · 奉酒', localBaojiGroupIds: ['photo-group-3263', 'photo-group-3273', 'photo-group-3424'], relationTypeIds: ['zun', 'hu', 'fangyi'], sourceIds: ['BAOJI-PHOTO-INDEX', 'NMC-RITUAL'] }),
    type({ slug: 'lei', nameZh: '罍', nameEn: 'LARGE WINE CONTAINER', romanization: 'LEI', reading: 'léi', quickGuide: '阔肩、深腹，体量通常较大，多有圈足和附耳。商周至战国常用于贮盛酒液，并与尊、壶等共同陈设。', categoryId: 'wine', shortFunction: '贮酒 · 盛液 · 陈设', localBaojiGroupIds: ['photo-group-3306', 'photo-group-3546'], relationTypeIds: ['zun', 'hu', 'you'], sourceIds: ['BAOJI-PHOTO-INDEX', 'NMC-RITUAL'], visualAsset: 'assets/types/lei-use-hero.png', notes: '罍与壶都能进入液体容纳路径，但器体比例、口部与时代变化不可混写。' }),
    ...
    type({ slug: 'gong', nameZh: '觥', nameEn: 'ANIMAL-SHAPED WINE VESSEL', romanization: 'GONG', reading: 'gōng', quickGuide: '多见有盖的鸟兽形或复合兽形，前端常形成流，后部可设鋬。商周时用于盛酒或斟酒，造型也服务于礼仪陈设。', categoryId: 'wine', shortFunction: '盛酒 · 倾注 · 礼仪', relationTypeIds: ['zun', 'you', 'jue'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/gong-use-hero.png', notes: '觥的动物形态与盖、流等构件需以具体器例说明，不以想象复原补足。' }),
    ...
    type({ slug: 'fou', nameZh: '缶', nameEn: 'LARGE CONTAINER', romanization: 'FOU', categoryId: 'wine', shortFunction: '盛液 · 储存 · 容器', relationTypeIds: ['hu', 'lei', 'zun'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/fou-use-hero.png', notes: '缶的具体时代、形制与液体用途需回到对象材料，不能由字形或容量单位推断。' }),
    ...
    type({ slug: 'yi', nameZh: '匜', nameEn: 'POURING VESSEL', romanization: 'YI', reading: 'yí', quickGuide: '器身像带流的浅盂，前端出水，后部有鋬，部分器例带足。西周中晚期以后常与盘配合，用于沃盥注水。', categoryId: 'water-pouring', shortFunction: '注水 · 倾注 · 盥洗', relationTypeIds: ['pan', 'he', 'jian-water'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/yi-use-hero.png', notes: '匜以流与持握结构区分于盉；没有宝鸡本地照片也不影响其 canonical 类型。' }),
    type({ slug: 'he', nameZh: '盉', nameEn: 'SPOUTED VESSEL', romanization: 'HE', reading: 'hé', quickGuide: '通常有盖、有流、有鋬，足部可作三足或圈足。商周时用来盛液、注水，也可能参与调和酒水，具体用途须看器形与同出组合。', categoryId: 'water-pouring', shortFunction: '盛液 · 倾注 · 配合', localBaojiGroupIds: ['photo-group-3386', 'photo-group-3541', 'photo-group-3740'], relationTypeIds: ['pan', 'yi', 'hu'], sourceIds: ['BAOJI-PHOTO-INDEX', 'NMC-HE'] }),
    type({ slug: 'jian-water', nameZh: '鉴', nameEn: 'LARGE WATER BASIN', romanization: 'JIAN', reading: 'jiàn', quickGuide: '宽口、深腹、体量大，多有附耳，外形近大型盆。春秋战国的鉴可用于盛水、沐浴或照容，特定组合中也可置冰镇酒。', categoryId: 'water-pouring', shortFunction: '盛水 · 承接 · 照容', relationTypeIds: ['pan', 'yu', 'yi'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/jian-water-use-hero.png', notes: '鉴的容量与器体规模使其与盘、盂形成比较路径；具体动作仍需器例支持。' }),
    ...
    type({ slug: 'ying', nameZh: '鎣', nameEn: 'LIDDED WATER VESSEL', romanization: 'YING', categoryId: 'water-pouring', shortFunction: '盛水 · 注水 · 盥洗', relationTypeIds: ['he', 'yi', 'pan'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['陕西历史博物馆 · 伯百父鎣'], notes: '鎣是与盥洗、注水相关的有盖水器，流、鋬和盖合关系共同限定动作。陕西历史博物馆站的伯百父鎣为跨馆器例，不能并入盉或匜。' }),
    ...
    type({ slug: 'dou-measure', nameZh: '斗', nameEn: 'MEASURING SCOOP', romanization: 'DOU', categoryId: 'measures', shortFunction: '量取 · 转移 · 定量', localBaojiGroupIds: ['photo-group-3558'], relationTypeIds: ['sheng', 'liang', 'shao'], sourceIds: ['BAOJI-PHOTO-INDEX', 'NMC-RITUAL'], notes: '量斗与食器豆是两个不同器型；本项不写成高足盛食器。' }),
    ...
    type({ slug: 'bo', nameZh: '镈', nameEn: 'LARGE BELL', romanization: 'BO', reading: 'bó', quickGuide: '体量较大、器壁厚重，顶部设钮，靠悬挂后敲击发声。镈可单悬或与钟编列，用于祭祀、宴飨等礼乐场合。', categoryId: 'music', shortFunction: '悬置 · 击奏 · 礼乐', localBaojiGroupIds: ['photo-group-3656'], relationTypeIds: ['zhong', 'bianzhong', 'nao'], sourceIds: ['BAOJI-PHOTO-INDEX', 'NMC-MUSIC'] }),
    type({ slug: 'nao', nameZh: '铙', nameEn: 'HAND BELL', romanization: 'NAO', reading: 'náo', quickGuide: '器体呈合瓦形、内无舌，下部有中空短柄，常将器口朝上击奏。商周时既用于军旅信号，也见于祭祀和宴乐。', categoryId: 'music', shortFunction: '持奏 · 击发 · 节奏', relationTypeIds: ['zhong', 'ling', 'zheng'], sourceIds: ['NMC-MUSIC'], visualAsset: 'assets/types/nao-use-hero.png' }),
    type({ slug: 'zheng', nameZh: '钲', nameEn: 'RITUAL GONG', romanization: 'ZHENG', reading: 'zhēng', quickGuide: '器体多呈狭长的合瓦形，内无舌，下接柄部，以槌击发声。先秦钲可用于军中节鼓、传令，也进入礼乐活动；它与铙的分界并非处处一致。', categoryId: 'music', shortFunction: '悬置 · 击奏 · 指令', relationTypeIds: ['zhong', 'nao', 'ling'], sourceIds: ['NMC-MUSIC'], visualAsset: 'assets/types/zheng-use-hero.png' }),
    ...
    type({ slug: 'qing', nameZh: '磬', nameEn: 'STONE CHIME', romanization: 'QING', categoryId: 'music', shortFunction: '悬置 · 击奏 · 金石合乐', relationTypeIds: ['bianqing', 'bianzhong', 'zhong'], sourceIds: ['NMC-MUSIC'], materialClass: 'stone', inventoryStatus: 'ADJACENT_NON_BRONZE', notes: '磬以石或玉材制成，曲折片状器体经悬挂敲击发声。它作为礼乐关联器进入本场景，但不计入青铜类型总数。' }),
    type({ slug: 'bianqing', nameZh: '编磬', nameEn: 'GRADUATED STONE CHIME SET', romanization: 'BIANQING', categoryId: 'music', shortFunction: '编列 · 悬置 · 合奏', relationTypeIds: ['qing', 'bianzhong', 'bianbo'], sourceIds: ['NMC-MUSIC'], materialClass: 'mixed', inventoryStatus: 'ADJACENT_NON_BRONZE', notes: '编磬由多件石质或玉质磬按音列编悬，和编钟共同构成金石礼乐系统。它是相邻礼乐系统，不得计入青铜器型数量。' }),
    ...
    type({ slug: 'jin', nameZh: '禁', nameEn: 'Vessel Stand', romanization: 'JIN', reading: 'jìn', quickGuide: '多作长方形或方形低台，台面平整，部分器例通体镂空。它不是容器，而是承置尊、卣等酒器的礼仪器座。', categoryId: 'ritual-accessories', shortFunction: '承置 · 抬高 · 稳定', localBaojiGroupIds: ['photo-group-3255'], relationTypeIds: ['zun', 'you', 'hu'], sourceIds: ['BAOJI-PHOTO-INDEX', 'NMC-RITUAL'], notes: '禁是承置器，不是容器；其功能来自支撑面与器物组合。' }),
    type({ slug: 'dou-ladle', nameZh: '挹酒斗', nameEn: 'WINE LADLE', romanization: 'YIJIU DOU', categoryId: 'ritual-accessories', shortFunction: '挹酒 · 转移 · 斟酌', relationTypeIds: ['jin', 'shao', 'zun'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/dou-ladle-use-hero.png', notes: '此处的斗指挹酒长柄勺，与量器之斗分列；器名相同，动作和组合关系不同。' }),
    ...
    type({ slug: 'bi', nameZh: '匕', nameEn: 'Serving Knife / Spoon', romanization: 'BI', categoryId: 'ritual-accessories', shortFunction: '取食 · 分取 · 奉持', localBaojiGroupIds: ['photo-group-3531'], relationTypeIds: ['gui', 'ding', 'yu'], sourceIds: ['BAOJI-PHOTO-INDEX', 'NMC-RITUAL'], notes: '此处按取食器与礼仪辅助器具记录，不把所有同字对象泛化为兵器。' }),
    ...
    type({ slug: 'xunlu', nameZh: '熏炉', nameEn: 'CENSER', romanization: 'XUNLU', categoryId: 'daily-life', shortFunction: '焚香 · 受热 · 散香', relationTypeIds: ['lu', 'deng'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/xunlu-use-hero.png' }),
    ...
    type({ slug: 'zhen', nameZh: '铜镇', nameEn: 'BRONZE WEIGHT', romanization: 'TONGZHEN', categoryId: 'daily-life', shortFunction: '压席 · 镇物 · 陈设', relationTypeIds: ['jing', 'lian', 'xingzao'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['西安博物院 · 人形铜镇 / 凤鸟铜镇', '陕西历史博物馆 · 鎏金铜虎镇'], notes: '铜镇以紧凑重量和稳定底面压席或镇物，常结合动物或人物造型。跨馆器例说明它是独立生活器用类型，不只是小型雕塑。' }),
    type({ slug: 'xingzao', nameZh: '行灶', nameEn: 'PORTABLE STOVE', romanization: 'XINGZAO', categoryId: 'daily-life', shortFunction: '承锅 · 通火 · 炊用', relationTypeIds: ['lu', 'yundou', 'fu-cauldron'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['西安博物院 · 三眼行灶'], notes: '行灶以火门、灶眼和承锅结构构成可移动的炊事设施。西安博物院的三眼行灶说明灶具本身应与锅釜分列。' }),
    ...
    type({ slug: 'cheyu-shi', nameZh: '车舆饰', nameEn: 'CHARIOT FITTING', romanization: 'CHEYUSHI', categoryId: 'chariot-harness', shortFunction: '车舆 · 固定 · 装饰', relationTypeIds: ['zhou-shi', 'e-shi'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/cheyu-shi-use-hero.png' }),
    ...
    type({ slug: 'chema-paoshi', nameZh: '车马泡饰', nameEn: 'HARNESS BOSS', romanization: 'CHEMA PAOSHI', categoryId: 'chariot-harness', shortFunction: '系固 · 装饰 · 护带', relationTypeIds: ['danglu', 'biao', 'cheyu-shi'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', notes: '泡饰以隆起圆面和背部系扣安装于车马带具，兼具装饰与护带作用。背部连接结构比正面纹样更能限定其用途。' }),

    // I · Architectural bronzes
    type({ slug: 'longwen-jianfang', nameZh: '龙纹单头齿方筒形铜构件', nameEn: 'DRAGON-MOTIF ARCHITECTURAL FITTING', romanization: 'LONGWEN JIANFANG', categoryId: 'architecture', shortFunction: '套接 · 固定 · 建筑装饰', relationTypeIds: ['longwen-goujian'], sourceIds: ['BAOJI-OFFICIAL', 'NMC-RITUAL'], visualAsset: 'assets/types/longwen-jianfang-use-hero.png', notes: '保留建筑部件的连接与固定语义，不把纹饰本身当作器物功能。' }),
    type({ slug: 'longwen-goujian', nameZh: '龙纹铜构件', nameEn: 'DRAGON-MOTIF BRONZE FITTING', romanization: 'LONGWEN GOUJIAN', categoryId: 'architecture', shortFunction: '连接 · 固定 · 装饰', relationTypeIds: ['longwen-jianfang'], sourceIds: ['BAOJI-OFFICIAL', 'NMC-RITUAL'], visualAsset: 'assets/types/longwen-goujian-use-hero.png', notes: '建筑功能明确时归入构件类；对象名称和部位仍需馆方资料核对。' }),
    ...
    type({ slug: 'tongshi', nameZh: '铜饰件', nameEn: 'BRONZE FITTING / ORNAMENT', romanization: 'TONGSHI', categoryId: 'other', shortFunction: '装饰 · 固定 · 随身', relationTypeIds: ['daigou', 'cheyu-shi'], sourceIds: ['NMC-RITUAL'], visualAsset: 'assets/types/tongshi-use-hero.png', notes: '仅在对象功能明确而不属于建筑、车马或礼仪附属器时使用此类。' }),
    type({ slug: 'hufu', nameZh: '虎符', nameEn: 'TIGER TALLY', romanization: 'HUFU', categoryId: 'other', shortFunction: '分合 · 凭验 · 调发', relationTypeIds: ['tongjie', 'tongyin', 'tongban'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['西安博物院 · 齐郡太守虎符 / 鲁王虎符'], notes: '虎符以可分合的虎形器体和铭文承担军政调发凭验，本身不是兵器。西安博物院站的两件虎符说明其应作为独立符信类型。' }),
    type({ slug: 'tongyin', nameZh: '铜印', nameEn: 'BRONZE SEAL', romanization: 'TONGYIN', categoryId: 'other', shortFunction: '钤印 · 凭信 · 行政', relationTypeIds: ['hufu', 'tongjie', 'tongban'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['陕西历史博物馆 · 霞州指挥使铜印 / 总领军马铜印'], notes: '铜印由印面、反书印文和钮部构成文书与身份凭信。跨馆器例显示其功能依赖文字、佩系与制度环境。' }),
    type({ slug: 'tongbi', nameZh: '铜币', nameEn: 'BRONZE CURRENCY', romanization: 'TONGBI', categoryId: 'other', shortFunction: '交换 · 计值 · 流通', relationTypeIds: ['tongliang', 'quan', 'tongyin'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['陕西历史博物馆 · 贵霜铜币'], notes: '铜币以铸造形制、重量和文字进入交换与计值体系，单枚器物还需结合时代和流通区域判断。此处保留钱币系统入口，不把每种币制重复拆成器型。' }),
    type({ slug: 'zaoxiang', nameZh: '铜造像', nameEn: 'BRONZE DEVOTIONAL IMAGE', romanization: 'TONG ZAOXIANG', categoryId: 'other', shortFunction: '造像 · 供奉 · 礼拜', relationTypeIds: ['tongshi', 'gaozubei', 'tongban'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['西安博物院 · 鎏金铜造像', '陕西历史博物馆 · 佛菩萨三尊铜造像'], notes: '铜造像以人物或神佛形象、台座和表面工艺进入供奉与礼拜语境。它属于铸造图像类型，不与一般铜饰件合并。' }),
    type({ slug: 'tongban', nameZh: '铜板', nameEn: 'BRONZE PLATE / PRINTING BLOCK', romanization: 'TONGBAN', categoryId: 'other', shortFunction: '刻写 · 印制 · 记录', relationTypeIds: ['tongyin', 'tongjie', 'hufu'], sourceIds: ['NMC-RITUAL'], inventoryStatus: 'ADD', crossMuseumRefs: ['陕西历史博物馆 · “交钞”铜板'], notes: '铜板以平整版面、反字或格局承担印制和记录功能。陕西历史博物馆站的交钞铜板表明版具不能并入普通建筑或装饰铜片。' }),

    // K · Bronze weapons
    type({ slug: 'jian-weapon', nameZh: '剑', nameEn: 'SWORD', romanization: 'JIAN', categoryId: 'weapons', shortFunction: '刺击 · 劈斩 · 佩持', relationTypeIds: ['dao-weapon', 'mao-weapon', 'ge-weapon'], sourceIds: ['NMC-WEAPONS'], inventoryStatus: 'ADD' }),
    type({ slug: 'ge-weapon', nameZh: '戈', nameEn: 'DAGGER-AXE', romanization: 'GE', categoryId: 'weapons', shortFunction: '勾啄 · 横击 · 装柲', relationTypeIds: ['ji-weapon', 'mao-weapon', 'yue-weapon'], sourceIds: ['NMC-WEAPONS'], inventoryStatus: 'ADD' }),
    ...
    type({ slug: 'dao-weapon', nameZh: '刀', nameEn: 'KNIFE', romanization: 'DAO', categoryId: 'weapons', shortFunction: '切割 · 劈斩 · 持握', relationTypeIds: ['jian-weapon', 'yue-weapon', 'ge-weapon'], sourceIds: ['NMC-WEAPONS'], inventoryStatus: 'ADD' }),
    ...
    type({ slug: 'nuji', nameZh: '弩机', nameEn: 'CROSSBOW TRIGGER', romanization: 'NUJI', categoryId: 'weapons', shortFunction: '扣弦 · 击发 · 远射', relationTypeIds: ['zu-arrowhead', 'jian-weapon', 'mao-weapon'], sourceIds: ['NMC-WEAPONS'], inventoryStatus: 'ADD', officialExampleLinks: ['https://www.chnmuseum.cn/zp/zpml/kgfjp/202110/t20211027_251877.shtml'] }),
  ];
