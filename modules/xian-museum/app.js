(function () {
  ...
  renderRoutes();
  render();
  document.querySelector(".featured-open")?.addEventListener("click", () => openItem("xian-001-painted-mirror", { syncUrl: true }));
  const initialItem = getItemFromLocation();
  if (initialItem) openItem(initialItem, { syncUrl: false });
}());
