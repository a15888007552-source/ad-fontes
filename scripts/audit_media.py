...
AUDIT_OUTPUT_PATHS = {
    ...
    "data/qinhan-r2-upload-verification.json",
    "data/qinhan-r2-runtime-verification.json",
    "data/qinhan-externalized-media.json",
    "data/qinhan-externalized-media-validation.json",
    ...
    "docs/QINHAN_R2_UPLOAD.md",
    "docs/QINHAN_R2_RUNTIME.md",
    "docs/QINHAN_MEDIA_EXTERNALIZED.md",
